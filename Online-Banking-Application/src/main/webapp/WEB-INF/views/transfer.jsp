...
<body>
	...
	<div align="center">
		<frm:form action="makeTransfer" method="POST" modelAttribute="bankTransaction" name="bankTransactionForm">
			<table>
				<tr>
				...
				<tr>
					<td>Enter Recepient's Account ID:</td>
					<td><frm:input name="trxToAccount" path="trxToAccount" /></td>
				</tr>
				...
				<tr>
					<td colspan="2"><input type="submit"
						value="Transfer" class="btn btn-danger"/></td>
				</tr>
			</table>
		</frm:form>
		</div>

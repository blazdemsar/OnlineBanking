...
public class AppConfig implements WebMvcConfigurer {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setAnnotatedClasses(User.class, Role.class, Account.class, Customer.class, BankTransaction.class, Branch.class);
   ...
   @Override  // useful when you want to use the images and css in your web pages but you are not using spring boot.
   ...
   public JavaMailSender mailSender() {
	   ...
	   javaMailProperties.setProperty("mail.transport.protocol", "smtp"); // smtp = simple mail transfer protocol
	   javaMailProperties.setProperty("mail.smtp.auth", "true");
	   javaMailProperties.setProperty("mail.debug", "true");
	   javaMailProperties.setProperty("mail.smtp.starttls.enable", "true"); // starttls works for both transport layer security (TLS) as well as for SSL
